...
# Задача №19 (вторая тема: Строки, срезы и методы)
#
# Дана строка:
# file_path = "/usr/local/bin/python3.9"
#
# Выведите длину этой строки.
#
# Используя метод строк, разделите строку на части по разделителю "/".
# Сохраните результат в список и выведите его.
#
# Используя срезы, получите и выведите:
# Последние 8 символов строки.
# Подстроку от начала до первого вхождения символа "." (не включая точку).
# Проверьте, заканчивается ли исходная строка на "python3.9" (используйте метод строк).
# Замените в исходной строке подстроку "python3.9" на "python3.10".
# Вывод организуйте в столбик (каждый ответ с новой строки, всего 6 строк).
...
substring = file_path[:dot_index]
print(substring)

end_result = file_path.endswith("python3.9")
print(end_result)

new_text = file_path.replace("python3.9", "python3.10")
print(new_text)

# Задача №20 (вторая тема: F-строки, конкатенация, методы строк)
#
# У вас есть данные:
# test_suite = "Регрессионные тесты"
# total_cases = 150
# passed_cases = 142
#
# Используя конкатенацию строк, создайте и выведите строку:
# "Набор тестов: [test_suite]"
#
# Используя f-строку, создайте и выведите строку:
# "Успешно: [passed_cases] из [total_cases]"
#
# Рассчитайте процент успешных тестов и с помощью f-строки с форматированием выведите строку:
# "Процент прохождения: [процент]%"
# (Ограничьте вывод до одного знака после запятой, используя {выражение:.1f}).
#
# Используя методы строк, приведите строку test_suite к нижнему регистру и
# замените в ней пробелы на символ подчёркивания _.Выведите результат.
#
# Проверьте, начинается ли исходная строка test_suite с подстроки "Рег" (используйте метод строк).
# Вывод организуйте в столбик (каждый ответ с новой строки, всего 5 строк).
...
string_1 = "Набор тестов: " + test_suite
print(string_1)

string_2 = f"Успешно: {passed_cases} из {total_cases}"
print(string_2)

string_3 = f"Процент прохождения: {(passed_cases / total_cases) * 100:.1f}%"
print(string_3)

string_4 = test_suite.lower()
string_5 = string_4.replace(" ", "_")
print(string_5)
